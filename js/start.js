...
const select = []; // 빈배열만들기 
  ...
  function setResult(){
    ...
    resultImg.classList.add('img-fluid'); // 이미지 클래스 추가 (가로 100%)
...
function addAnswer(answerText, qIdx, i ){
    ...
    button.addEventListener('click', function(e){
        ...
        // console.log(e);
        // e.target.style = 'none';
        // 클릭한 태그의 부모태그에서 모든 하위태그들을 선택하여 전부제거
...
goNext(0); // 처음에 0번째, 즉 1번 문제 및 답변이 화면에 출력 
